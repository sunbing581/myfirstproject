...
<div class="web_con">
    <div class="head_con padd10">
        <div class="wap980 padd10 text-right clearfix">
            <a href="">登录</a> <a href="/index.php/mvc/welcome/register">注册</a>
        </div>
        <div class="wap980 padd10">
            <h1 class="text-center padd10">欢乐购 — 网购就上欢乐购</h1>
            <h3 class="text-center ">大学校园最火爆的网上购物渠道</h3>
            <h3 class="text-center ">听说今天有红包，你领了吗？</h3>
            <h3 class="text-center ">什么还没注册？你OUT了！！！</h3>
